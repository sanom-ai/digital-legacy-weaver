...
void main() {
  testWidgets('Unlock screen renders core fields', (tester) async {
    ...
    expect(find.text('สิ่งที่ผู้รับควรเตรียม'), findsOneWidget);
    expect(find.text('ถ้าไม่ใช่ของคุณ'), findsOneWidget);
    ...
    expect(find.widgetWithText(TextField, 'รหัสยืนยัน'), findsOneWidget);
    ...
    expect(find.widgetWithText(OutlinedButton, 'ไม่ใช่ของฉัน'), findsOneWidget);
